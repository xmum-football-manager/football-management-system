  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Cap to the space available below the trigger (down to the viewport edge),
        // never more than 24rem — so the list overflows internally and scrolls
      ...
      position={position}
      // Always open downward instead of flipping up when space is tight; the
      // height cap above keeps a long list scrollable on short viewports.
      side="bottom"
